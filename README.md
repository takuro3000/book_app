...
| ・難易度と感想を投稿します       | ・紹介文やエンジニアのレベルなどが表示でき、編集ページに飛ぶことができます <br> ・ユーザーがレビューした本の一覧が表示されています |
...
| ・紹介文、アイコン、githubのurlなどを登録できます | ・アプリの紹介文がのっています |
| **Admin本投稿ページ**        |                               |
| <img src="/app/assets/images/new_book.png" alt="Admin本投稿ページ" style="width:100%; max-width:300px;"> |                               |
| ・Google Books APIを利用して、検索すると本の概要情報を自動入力できるようにしています |                               |
